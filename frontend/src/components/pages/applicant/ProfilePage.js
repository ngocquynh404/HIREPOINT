            ...
            <div className="profile-management-content">
                <div className="profile-management-info">
                    ...
                    <FaEdit
                        ...
                        className="profile-management-edit-icon-user" />
                </div>

                <div className="profile-management-container">
                    <div className="profile-management-applications-section">
                        <h2 className="profile-management-applications-title">Số lượng đơn ứng tuyển</h2>
                        <div className="profile-management-applications-card">
                            <p>Bạn đã ứng tuyển</p>
                            <span className="profile-management-applications-count">{applications}</span>
                            <p>đơn</p>
                        </div>
                    </div>

                    <div className="profile-management-applications-section">
                        <h2 className="profile-management-applications-title">Quyền riêng tư</h2>
                        <div className="profile-management-applications-card">
                            <div className="profile-management-privacy-toggle">
                                <label className="profile-management-switch">
                                    <input type="checkbox" className="profile-management-checkbox" />
                                    <span className="profile-management-slider"></span>
                                </label>
                                <span className="profile-management-toggle-label">Cho phép NTD tìm kiếm hồ sơ</span>
                            </div>
                            ...
                            <div className="profile-management-privacy-toggle">
                                ...
                                <span className="profile-management-toggle-label">Ẩn thông tin cá nhân</span>
                            </div>
                        </div>
                    </div>
