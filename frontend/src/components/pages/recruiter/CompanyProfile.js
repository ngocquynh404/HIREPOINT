                        ...
                        <div className="company-profile-empty-state">
                            <div className="company-profile-edit-basic-info">
                                ...
                                <div className="company-profile-edit-row">
                                    ...
                                    <div
                                        className={`company-profile-dropzone ${image ? "has-image" : ""}`}
                                        onDrop={handleDrop}
                                    ...
                                    >
                                        {!image ? (
                                            ...
                                            <div className="company-profile-image-container">
                                                <img src={image} alt="Uploaded" className="company-profile-image" />
                                                <div className="company-profile-image-actions">
                                                    ...
                                                    <button
                                                        className="company-profile-action-button"
                                                        onClick={() => alert("Thay đổi ảnh (Chức năng chưa có)")}
                                                    >
                                                        Thay Đổi
                                                    </button>
                                                    <button
                                                        className="company-profile-action-button"
                                                        onClick={() => alert("Xem trước ảnh (Chức năng chưa có)")}
                                                    >
                                                        Xem Trước
                                                    </button>
                                                </div>
