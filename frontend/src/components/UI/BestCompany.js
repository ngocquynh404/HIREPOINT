            ...
            <div className="top-companies-container">
                {currentItems.map((company, index) => (
                    <div key={index} className="top-company-card">
                        ...
                        <p className="top-company-title">{company.name}</p>
                        <p className="top-company-industry">{company.industry}</p>
                        <p className="top-company-job-count">{company.jobCount} việc mới</p>
                        <button className="top-company-button">VIỆC MỚI</button>
                    </div>
                ))}
            </div>
